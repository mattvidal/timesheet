...
{
    public abstract class TimesheetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TimesheetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TimesheetWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TimesheetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TimesheetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TimesheetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TimesheetDbContext, Task<T>> func)
        {
            T result;
